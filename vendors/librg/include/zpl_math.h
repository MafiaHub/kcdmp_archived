...
typedef float zpl_float2[2];
typedef float zpl_float3[3];
typedef float zpl_float4[4];


typedef struct zpl_rect2 { zpl_vec2 pos, dim; } zpl_rect2;
typedef struct zpl_rect3 { zpl_vec3 pos, dim; } zpl_rect3;

typedef struct zpl_aabb2 { zpl_vec2 centre, half_size; } zpl_aabb2;
typedef struct zpl_aabb3 { zpl_vec3 centre, half_size; } zpl_aabb3;
...
typedef unsigned long long zpl_u64;
#endif
#endif
...
#define zpl_sign(x) ((x) >= 0 ? 1 : -1)
    ...
    zpl_DEF float zpl_to_radians(float degrees);
    zpl_DEF float zpl_to_degrees(float radians);

    /* NOTE: Because to interpolate angles */
    zpl_DEF float zpl_angle_diff(float radians_a, float radians_b);
...
#define zpl_max3(a, b, c) zpl_max(zpl_max(a, b), c)
    ...
    zpl_DEF float zpl_copy_sign  (float x, float y);
    zpl_DEF float zpl_remainder  (float x, float y);
    zpl_DEF float zpl_mod        (float x, float y);
    zpl_DEF float zpl_sqrt       (float a);
    zpl_DEF float zpl_rsqrt      (float a);
    zpl_DEF float zpl_quake_rsqrt(float a); /* NOTE: It's probably better to use 1.0f/zpl_sqrt(a)
* And for simd, there is usually isqrt functions too!
*/
    zpl_DEF float zpl_sin    (float radians);
    zpl_DEF float zpl_cos    (float radians);
    zpl_DEF float zpl_tan    (float radians);
    zpl_DEF float zpl_arcsin (float a);
    zpl_DEF float zpl_arccos (float a);
    zpl_DEF float zpl_arctan (float a);
    zpl_DEF float zpl_arctan2(float y, float x);

    zpl_DEF float zpl_exp      (float x);
    zpl_DEF float zpl_exp2     (float x);
    zpl_DEF float zpl_log      (float x);
    zpl_DEF float zpl_log2     (float x);
    zpl_DEF float zpl_fast_exp (float x);  /* NOTE: Only valid from -1 <= x <= +1 */
    zpl_DEF float zpl_fast_exp2(float x); /* NOTE: Only valid from -1 <= x <= +1 */
    zpl_DEF float zpl_pow      (float x, float y); /* x^y */

    zpl_DEF float zpl_round(float x);
    zpl_DEF float zpl_floor(float x);
    zpl_DEF float zpl_ceil (float x);

    zpl_DEF float  zpl_half_to_float(zpl_half value);
    zpl_DEF zpl_half zpl_floato_half(float value);


    zpl_DEF zpl_vec2 zpl_vec2f_zero(void);
    zpl_DEF zpl_vec2 zpl_vec2f     (float x, float y);
    zpl_DEF zpl_vec2 zpl_vec2fv    (float x[2]);

    zpl_DEF zpl_vec3 zpl_vec3f_zero(void);
    zpl_DEF zpl_vec3 zpl_vec3f     (float x, float y, float z);
    zpl_DEF zpl_vec3 zpl_vec3fv    (float x[3]);

    zpl_DEF zpl_vec4 zpl_vec4f_zero(void);
    zpl_DEF zpl_vec4 zpl_vec4f     (float x, float y, float z, float w);
    zpl_DEF zpl_vec4 zpl_vec4fv    (float x[4]);


    zpl_DEF void zpl_vec2_add(zpl_vec2 *d, zpl_vec2 v0, zpl_vec2 v1);
    zpl_DEF void zpl_vec2_sub(zpl_vec2 *d, zpl_vec2 v0, zpl_vec2 v1);
    zpl_DEF void zpl_vec2_mul(zpl_vec2 *d, zpl_vec2 v,  float s);
    zpl_DEF void zpl_vec2_div(zpl_vec2 *d, zpl_vec2 v,  float s);

    zpl_DEF void zpl_vec3_add(zpl_vec3 *d, zpl_vec3 v0, zpl_vec3 v1);
    zpl_DEF void zpl_vec3_sub(zpl_vec3 *d, zpl_vec3 v0, zpl_vec3 v1);
    zpl_DEF void zpl_vec3_mul(zpl_vec3 *d, zpl_vec3 v,  float s);
    zpl_DEF void zpl_vec3_div(zpl_vec3 *d, zpl_vec3 v,  float s);

    zpl_DEF void zpl_vec4_add(zpl_vec4 *d, zpl_vec4 v0, zpl_vec4 v1);
    zpl_DEF void zpl_vec4_sub(zpl_vec4 *d, zpl_vec4 v0, zpl_vec4 v1);
    zpl_DEF void zpl_vec4_mul(zpl_vec4 *d, zpl_vec4 v,  float s);
    zpl_DEF void zpl_vec4_div(zpl_vec4 *d, zpl_vec4 v,  float s);

    zpl_DEF void zpl_vec2_addeq(zpl_vec2 *d, zpl_vec2 v);
    zpl_DEF void zpl_vec2_subeq(zpl_vec2 *d, zpl_vec2 v);
    zpl_DEF void zpl_vec2_muleq(zpl_vec2 *d, float s);
    zpl_DEF void zpl_vec2_diveq(zpl_vec2 *d, float s);

    zpl_DEF void zpl_vec3_addeq(zpl_vec3 *d, zpl_vec3 v);
    zpl_DEF void zpl_vec3_subeq(zpl_vec3 *d, zpl_vec3 v);
    zpl_DEF void zpl_vec3_muleq(zpl_vec3 *d, float s);
    zpl_DEF void zpl_vec3_diveq(zpl_vec3 *d, float s);

    zpl_DEF void zpl_vec4_addeq(zpl_vec4 *d, zpl_vec4 v);
    zpl_DEF void zpl_vec4_subeq(zpl_vec4 *d, zpl_vec4 v);
    zpl_DEF void zpl_vec4_muleq(zpl_vec4 *d, float s);
    zpl_DEF void zpl_vec4_diveq(zpl_vec4 *d, float s);

    zpl_DEF float zpl_vec2_dot(zpl_vec2 v0, zpl_vec2 v1);
    zpl_DEF float zpl_vec3_dot(zpl_vec3 v0, zpl_vec3 v1);
    zpl_DEF float zpl_vec4_dot(zpl_vec4 v0, zpl_vec4 v1);

    zpl_DEF void zpl_vec2_cross(float *d, zpl_vec2 v0, zpl_vec2 v1);
    zpl_DEF void zpl_vec3_cross(zpl_vec3 *d, zpl_vec3 v0, zpl_vec3 v1);

    zpl_DEF float zpl_vec2_mag2(zpl_vec2 v);
    zpl_DEF float zpl_vec3_mag2(zpl_vec3 v);
    zpl_DEF float zpl_vec4_mag2(zpl_vec4 v);

    zpl_DEF float zpl_vec2_mag(zpl_vec2 v);
    zpl_DEF float zpl_vec3_mag(zpl_vec3 v);
    zpl_DEF float zpl_vec4_mag(zpl_vec4 v);
    ...
    zpl_DEF void zpl_vec2_refract(zpl_vec2 *d, zpl_vec2 i, zpl_vec2 n, float eta);
    zpl_DEF void zpl_vec3_refract(zpl_vec3 *d, zpl_vec3 i, zpl_vec3 n, float eta);

    zpl_DEF float zpl_vec2_aspect_ratio(zpl_vec2 v);


    zpl_DEF void zpl_mat2_identity   (zpl_mat2 *m);
    zpl_DEF void zpl_float22_identity(float m[2][2]);
    ...
    zpl_DEF float zpl_mat2_determinate(zpl_mat2 *m);

    zpl_DEF zpl_mat2 *zpl_mat2_v(zpl_vec2 m[2]);
    zpl_DEF zpl_mat2 *zpl_mat2_f(float m[2][2]);
    zpl_DEF zpl_float2 *zpl_float22_m(zpl_mat2 *m);
    zpl_DEF zpl_float2 *zpl_float22_v(zpl_vec2 m[2]);
    zpl_DEF zpl_float2 *zpl_float22_4(float m[4]);

    zpl_DEF void zpl_float22_transpose(float (*vec)[2]);
    zpl_DEF void zpl_float22_mul      (float (*out)[2], float (*mat1)[2], float (*mat2)[2]);
    zpl_DEF void zpl_float22_mul_vec2 (zpl_vec2 *out, float m[2][2], zpl_vec2 in);


    zpl_DEF void zpl_mat3_identity   (zpl_mat3 *m);
    zpl_DEF void zpl_float33_identity(float m[3][3]);
    ...
    zpl_DEF float zpl_mat3_determinate(zpl_mat3 *m);


    zpl_DEF zpl_mat3 *zpl_mat3_v(zpl_vec3 m[3]);
    zpl_DEF zpl_mat3 *zpl_mat3_f(float m[3][3]);

    zpl_DEF zpl_float3 *zpl_float33_m(zpl_mat3 *m);
    zpl_DEF zpl_float3 *zpl_float33_v(zpl_vec3 m[3]);
    zpl_DEF zpl_float3 *zpl_float33_9(float m[9]);

    zpl_DEF void zpl_float33_transpose(float (*vec)[3]);
    zpl_DEF void zpl_float33_mul      (float (*out)[3], float (*mat1)[3], float (*mat2)[3]);
    zpl_DEF void zpl_float33_mul_vec3 (zpl_vec3 *out, float m[3][3], zpl_vec3 in);

    zpl_DEF void zpl_mat4_identity   (zpl_mat4 *m);
    zpl_DEF void zpl_float44_identity(float m[4][4]);
    ...
    zpl_DEF zpl_mat4 *zpl_mat4_f(float m[4][4]);

    zpl_DEF zpl_float4 *zpl_float44_m (zpl_mat4 *m);
    zpl_DEF zpl_float4 *zpl_float44_v (zpl_vec4 m[4]);
    zpl_DEF zpl_float4 *zpl_float44_16(float m[16]);

    zpl_DEF void zpl_float44_transpose(float (*vec)[4]);
    zpl_DEF void zpl_float44_mul      (float (*out)[4], float (*mat1)[4], float (*mat2)[4]);
    zpl_DEF void zpl_float44_mul_vec4 (zpl_vec4 *out, float m[4][4], zpl_vec4 in);


    zpl_DEF void zpl_mat4_translate           (zpl_mat4 *out, zpl_vec3 v);
    zpl_DEF void zpl_mat4_rotate              (zpl_mat4 *out, zpl_vec3 v, float angle_radians);
    zpl_DEF void zpl_mat4_scale               (zpl_mat4 *out, zpl_vec3 v);
    zpl_DEF void zpl_mat4_scalef              (zpl_mat4 *out, float s);
    zpl_DEF void zpl_mat4_ortho2d             (zpl_mat4 *out, float left, float right, float bottom, float top);
    zpl_DEF void zpl_mat4_ortho3d             (zpl_mat4 *out, float left, float right, float bottom, float top, float z_near, float z_far);
    zpl_DEF void zpl_mat4_perspective         (zpl_mat4 *out, float fovy, float aspect, float z_near, float z_far);
    zpl_DEF void zpl_mat4_infinite_perspective(zpl_mat4 *out, float fovy, float aspect, float z_near);

    zpl_DEF void zpl_mat4_look_at(zpl_mat4 *out, zpl_vec3 eye, zpl_vec3 centre, zpl_vec3 up);



    zpl_DEF zpl_quat zpl_quatf             (float x, float y, float z, float w);
    zpl_DEF zpl_quat zpl_quatfv            (float e[4]);
    zpl_DEF zpl_quat zpl_quat_axis_angle  (zpl_vec3 axis, float angle_radians);
    zpl_DEF zpl_quat zpl_quat_euler_angles(float pitch, float yaw, float roll);
    ...
    zpl_DEF void zpl_quat_mulf(zpl_quat *d, zpl_quat q, float s);
    zpl_DEF void zpl_quat_divf(zpl_quat *d, zpl_quat q, float s);
    ...
    zpl_DEF void zpl_quat_muleqf(zpl_quat *d, float s);
    zpl_DEF void zpl_quat_diveqf(zpl_quat *d, float s);




    zpl_DEF float zpl_quat_dot(zpl_quat q0, zpl_quat q1);
    zpl_DEF float zpl_quat_mag(zpl_quat q);
    ...
    zpl_DEF float zpl_quat_angle(zpl_quat q);

    zpl_DEF float zpl_quat_pitch(zpl_quat q);
    zpl_DEF float zpl_quat_yaw  (zpl_quat q);
    zpl_DEF float zpl_quat_roll (zpl_quat q);
    ...
    /* Interpolations */
    zpl_DEF float zpl_lerp         (float a, float b, float t);
    zpl_DEF float zpl_unlerp       (float t, float a, float b);
    zpl_DEF float zpl_smooth_step  (float a, float b, float t);
    zpl_DEF float zpl_smoother_step(float a, float b, float t);

    zpl_DEF void zpl_vec2_lerp(zpl_vec2 *d, zpl_vec2 a, zpl_vec2 b, float t);
    zpl_DEF void zpl_vec3_lerp(zpl_vec3 *d, zpl_vec3 a, zpl_vec3 b, float t);
    zpl_DEF void zpl_vec4_lerp(zpl_vec4 *d, zpl_vec4 a, zpl_vec4 b, float t);

    zpl_DEF void zpl_vec2_cslerp(zpl_vec2 *d, zpl_vec2 a, zpl_vec2 v0, zpl_vec2 b, zpl_vec2 v1, float t);
    zpl_DEF void zpl_vec3_cslerp(zpl_vec3 *d, zpl_vec3 a, zpl_vec3 v0, zpl_vec3 b, zpl_vec3 v1, float t);
    zpl_DEF void zpl_vec2_dcslerp(zpl_vec2 *d, zpl_vec2 a, zpl_vec2 v0, zpl_vec2 b, zpl_vec2 v1, float t);
    zpl_DEF void zpl_vec3_dcslerp(zpl_vec3 *d, zpl_vec3 a, zpl_vec3 v0, zpl_vec3 b, zpl_vec3 v1, float t);

    zpl_DEF void zpl_quat_lerp (zpl_quat *d, zpl_quat a, zpl_quat b, float t);
    zpl_DEF void zpl_quat_nlerp(zpl_quat *d, zpl_quat a, zpl_quat b, float t);
    zpl_DEF void zpl_quat_slerp(zpl_quat *d, zpl_quat a, zpl_quat b, float t);
    zpl_DEF void zpl_quat_nquad(zpl_quat *d, zpl_quat p, zpl_quat a, zpl_quat b, zpl_quat q, float t);
    zpl_DEF void zpl_quat_squad(zpl_quat *d, zpl_quat p, zpl_quat a, zpl_quat b, zpl_quat q, float t);
    zpl_DEF void zpl_quat_slerp_approx(zpl_quat *d, zpl_quat a, zpl_quat b, float t);
    zpl_DEF void zpl_quat_squad_approx(zpl_quat *d, zpl_quat p, zpl_quat a, zpl_quat b, zpl_quat q, float t);
    ...
    zpl_DEF int zpl_rect2_contains           (zpl_rect2 a, float x, float y);
...
#endif
    /* Hashing */
    zpl_DEF zpl_u64 zpl_hash_murmur64(void const *key, size_t num_bytes, zpl_u64 seed);

    /* Random */
    /* TODO: Use a generator for the random numbers */
    zpl_DEF float zpl_random_range_float(float min_inc, float max_inc);
    zpl_DEF int   zpl_random_range_int  (int min_inc, int max_inc);
    zpl_DEF float zpl_random01          (void);
...
/* TODO: How should I apply zpl_DEF to these operator overloads? */
...
float zpl_to_radians(float degrees) { return degrees * zpl_TAU / 360.0f; }
float zpl_to_degrees(float radians) { return radians * 360.0f / zpl_TAU; }

float zpl_angle_diff(float radians_a, float radians_b) {
    float delta = zpl_mod(radians_b-radians_a, zpl_TAU);
...
float zpl_exp2(float x) { return zpl_exp(zpl_LOG_TWO * x); }
float zpl_log2(float x) { return zpl_log(x) / zpl_LOG_TWO; }
...
float zpl_fast_exp2(float x) { return zpl_fast_exp(zpl_LOG_TWO * x); }
...
float zpl_half_to_float(zpl_half value) {
...
zpl_half zpl_floato_half(float value) {
...
zpl_vec2 zpl_vec2f_zero(void)        { zpl_vec2 v = {0, 0};                return v; }
zpl_vec2 zpl_vec2f(float x, float y) { zpl_vec2 v; v.x = x;    v.y = y;    return v; }
zpl_vec2 zpl_vec2fv(float x[2])      { zpl_vec2 v; v.x = x[0]; v.y = x[1]; return v; }

zpl_vec3 zpl_vec3f_zero(void)                 { zpl_vec3 v = {0, 0, 0};                         return v; }
zpl_vec3 zpl_vec3f(float x, float y, float z) { zpl_vec3 v; v.x = x; v.y = y; v.z = z;          return v; }
zpl_vec3 zpl_vec3fv(float x[3])               { zpl_vec3 v; v.x = x[0]; v.y = x[1]; v.z = x[2]; return v; }

zpl_vec4 zpl_vec4f_zero(void)                          { zpl_vec4 v = {0, 0, 0, 0};                                  return v; }
zpl_vec4 zpl_vec4f(float x, float y, float z, float w) { zpl_vec4 v; v.x = x; v.y = y; v.z = z; v.w = w;             return v; }
zpl_vec4 zpl_vec4fv(float x[4])                        { zpl_vec4 v; v.x = x[0]; v.y = x[1]; v.z = x[2]; v.w = x[3]; return v; }
...
void zpl_vec2_mul(zpl_vec2 *d, zpl_vec2 v,  float s)   { zpl_VEC2_2OP(d,v,* s);      }
void zpl_vec2_div(zpl_vec2 *d, zpl_vec2 v,  float s)   { zpl_VEC2_2OP(d,v,/ s);      }
...
void zpl_vec3_mul(zpl_vec3 *d, zpl_vec3 v,  float s)   { zpl_VEC3_2OP(d,v,* s);      }
void zpl_vec3_div(zpl_vec3 *d, zpl_vec3 v,  float s)   { zpl_VEC3_2OP(d,v,/ s);      }
...
void zpl_vec4_mul(zpl_vec4 *d, zpl_vec4 v,  float s)   { zpl_VEC4_2OP(d,v,* s);      }
void zpl_vec4_div(zpl_vec4 *d, zpl_vec4 v,  float s)   { zpl_VEC4_2OP(d,v,/ s);      }
...
void zpl_vec2_muleq(zpl_vec2 *d, float s)  { zpl_VEC2_2OP(d,(*d),* s);    }
void zpl_vec2_diveq(zpl_vec2 *d, float s)  { zpl_VEC2_2OP(d,(*d),/ s);    }
...
void zpl_vec3_muleq(zpl_vec3 *d, float s)  { zpl_VEC3_2OP(d,(*d),* s);    }
void zpl_vec3_diveq(zpl_vec3 *d, float s)  { zpl_VEC3_2OP(d,(*d),/ s);    }
...
void zpl_vec4_muleq(zpl_vec4 *d, float s)  { zpl_VEC4_2OP(d,(*d),* s);    }
void zpl_vec4_diveq(zpl_vec4 *d, float s)  { zpl_VEC4_2OP(d,(*d),/ s);    }
...
float zpl_vec2_dot(zpl_vec2 v0, zpl_vec2 v1) { return v0.x*v1.x + v0.y*v1.y; }
float zpl_vec3_dot(zpl_vec3 v0, zpl_vec3 v1) { return v0.x*v1.x + v0.y*v1.y + v0.z*v1.z; }
float zpl_vec4_dot(zpl_vec4 v0, zpl_vec4 v1) { return v0.x*v1.x + v0.y*v1.y + v0.z*v1.z + v0.w*v1.w; }

void zpl_vec2_cross(float *d, zpl_vec2 v0, zpl_vec2 v1) { *d = v0.x*v1.y - v1.x*v0.y; }
void zpl_vec3_cross(zpl_vec3 *d, zpl_vec3 v0, zpl_vec3 v1)  { d->x = v0.y*v1.z - v0.z*v1.y;
    d->y = v0.z*v1.x - v0.x*v1.z;
    d->z = v0.x*v1.y - v0.y*v1.x; }

float zpl_vec2_mag2(zpl_vec2 v) { return zpl_vec2_dot(v, v); }
float zpl_vec3_mag2(zpl_vec3 v) { return zpl_vec3_dot(v, v); }
float zpl_vec4_mag2(zpl_vec4 v) { return zpl_vec4_dot(v, v); }

/* TODO: Create custom sqrt function */
float zpl_vec2_mag(zpl_vec2 v) { return zpl_sqrt(zpl_vec2_dot(v, v)); }
float zpl_vec3_mag(zpl_vec3 v) { return zpl_sqrt(zpl_vec3_dot(v, v)); }
float zpl_vec4_mag(zpl_vec4 v) { return zpl_sqrt(zpl_vec4_dot(v, v)); }
...
void zpl_vec2_refract(zpl_vec2 *d, zpl_vec2 i, zpl_vec2 n, float eta) {
    zpl_vec2 a, b;
    float dv, k;
...
void zpl_vec3_refract(zpl_vec3 *d, zpl_vec3 i, zpl_vec3 n, float eta) {
    zpl_vec3 a, b;
    float dv, k;
...
float zpl_vec2_aspect_ratio(zpl_vec2 v) { return (v.y < 0.0001f) ? 0.0f : v.x/v.y; }
...
void zpl_mat2_mul(zpl_mat2 *out, zpl_mat2 *m1, zpl_mat2 *m2) { zpl_float22_mul(zpl_float22_m(out), zpl_float22_m(m1), zpl_float22_m(m2)); }
...
void zpl_float22_mul_vec2(zpl_vec2 *out, float m[2][2], zpl_vec2 v) {
    out->x = m[0][0]*v.x + m[0][1]*v.y;
    out->y = m[1][0]*v.x + m[1][1]*v.y;
}

float zpl_mat2_determinate(zpl_mat2 *m) {
...
void zpl_mat3_mul(zpl_mat3 *out, zpl_mat3 *m1, zpl_mat3 *m2) { zpl_float33_mul(zpl_float33_m(out), zpl_float33_m(m1), zpl_float33_m(m2)); }
...
void zpl_float33_mul_vec3(zpl_vec3 *out, float m[3][3], zpl_vec3 v) {
...
float zpl_mat3_determinate(zpl_mat3 *m) {
...
void zpl_mat4_mul(zpl_mat4 *out, zpl_mat4 *m1, zpl_mat4 *m2) { zpl_float44_mul(zpl_float44_m(out), zpl_float44_m(m1), zpl_float44_m(m2)); }
...
void zpl_float44_mul_vec4(zpl_vec4 *out, float m[4][4], zpl_vec4 v) {
...
void zpl_mat4_rotate(zpl_mat4 *out, zpl_vec3 v, float angle_radians) {
    float c, s;
    zpl_vec3 axis, t;
    zpl_float4 *rot;
...
void zpl_mat4_scalef(zpl_mat4 *out, float s) {
    zpl_mat4_identity(out);
    out->e[0]  = s;
    out->e[5]  = s;
    out->e[10] = s;
...
void zpl_mat4_ortho2d(zpl_mat4 *out, float left, float right, float bottom, float top) {
    zpl_float4 *m;
    zpl_mat4_identity(out);
    m = zpl_float44_m(out);
...
void zpl_mat4_ortho3d(zpl_mat4 *out, float left, float right, float bottom, float top, float z_near, float z_far) {
    zpl_float4 *m;
    zpl_mat4_identity(out);
    m = zpl_float44_m(out);
...
void zpl_mat4_perspective(zpl_mat4 *out, float fovy, float aspect, float z_near, float z_far) {
...
void zpl_mat4_infinite_perspective(zpl_mat4 *out, float fovy, float aspect, float z_near) {
...
zpl_quat zpl_quatf(float x, float y, float z, float w) { zpl_quat q; q.x = x; q.y = y; q.z = z; q.w = w; return q; }
zpl_quat zpl_quatfv(float e[4]) { zpl_quat q; q.x = e[0]; q.y = e[1]; q.z = e[2]; q.w = e[3]; return q; }

zpl_quat zpl_quat_axis_angle(zpl_vec3 axis, float angle_radians) {
    zpl_quat q;
...
zpl_quat zpl_quat_euler_angles(float pitch, float yaw, float roll) {
...
zpl_quat zpl_quat_identity(void) { zpl_quat q = {0, 0, 0, 1}; return q; }
...
void zpl_quat_div(zpl_quat *d, zpl_quat q0, zpl_quat q1){ zpl_quat iq1; zpl_quat_inverse(&iq1, q1); zpl_quat_mul(d, q0, iq1); }

void zpl_quat_mulf(zpl_quat *d, zpl_quat q0, float s) { zpl_vec4_mul(&d->xyzw, q0.xyzw, s); }
void zpl_quat_divf(zpl_quat *d, zpl_quat q0, float s) { zpl_vec4_div(&d->xyzw, q0.xyzw, s); }
...
void zpl_quat_muleqf(zpl_quat *d, float s) { zpl_vec4_muleq(&d->xyzw, s); }
void zpl_quat_diveqf(zpl_quat *d, float s) { zpl_vec4_diveq(&d->xyzw, s); }

float zpl_quat_dot(zpl_quat q0, zpl_quat q1) { float r = zpl_vec3_dot(q0.xyz, q1.xyz) + q0.w*q1.w; return r; }
float zpl_quat_mag(zpl_quat q)           { float r = zpl_sqrt(zpl_quat_dot(q, q)); return r; }

void zpl_quat_norm(zpl_quat *d, zpl_quat q)    { zpl_quat_divf(d, q, zpl_quat_mag(q)); }
void zpl_quat_conj(zpl_quat *d, zpl_quat q)    { d->xyz = zpl_vec3f(-q.x, -q.y, -q.z); d->w = q.w; }
void zpl_quat_inverse(zpl_quat *d, zpl_quat q) { zpl_quat_conj(d, q); zpl_quat_diveqf(d, zpl_quat_dot(q, q)); }


void zpl_quat_axis(zpl_vec3 *axis, zpl_quat q) {
    zpl_quat n; zpl_quat_norm(&n, q);
    zpl_vec3_div(axis, n.xyz, zpl_sin(zpl_arccos(q.w)));
}

float zpl_quat_angle(zpl_quat q) {
...
float zpl_quat_roll(zpl_quat q)  { return zpl_arctan2(2.0f*q.x*q.y + q.z*q.w, q.x*q.x + q.w*q.w - q.y*q.y - q.z*q.z); }
float zpl_quat_pitch(zpl_quat q) { return zpl_arctan2(2.0f*q.y*q.z + q.w*q.x, q.w*q.w - q.x*q.x - q.y*q.y + q.z*q.z); }
float zpl_quat_yaw(zpl_quat q)   { return zpl_arcsin(-2.0f*(q.x*q.z - q.w*q.y)); }
...
void zpl_vec2_lerp(zpl_vec2 *d, zpl_vec2 a, zpl_vec2 b, float t) { zpl_VEC_LERPN(2, d, a, b, t); }
void zpl_vec3_lerp(zpl_vec3 *d, zpl_vec3 a, zpl_vec3 b, float t) { zpl_VEC_LERPN(3, d, a, b, t); }
void zpl_vec4_lerp(zpl_vec4 *d, zpl_vec4 a, zpl_vec4 b, float t) { zpl_VEC_LERPN(4, d, a, b, t); }

#undef zpl_VEC_LERPN

void zpl_vec2_cslerp(zpl_vec2 *d, zpl_vec2 a, zpl_vec2 v0, zpl_vec2 b, zpl_vec2 v1, float t) {
    float t2  = t*t;
    float ti  = (t-1);
    float ti2 = ti*ti;
...
void zpl_vec3_cslerp(zpl_vec3 *d, zpl_vec3 a, zpl_vec3 v0, zpl_vec3 b, zpl_vec3 v1, float t) {
    float t2  = t*t;
    float ti  = (t-1);
    float ti2 = ti*ti;
...
void zpl_vec2_dcslerp(zpl_vec2 *d, zpl_vec2 a, zpl_vec2 v0, zpl_vec2 b, zpl_vec2 v1, float t) {
    float t2 = t * t;
...
void zpl_vec3_dcslerp(zpl_vec3 *d, zpl_vec3 a, zpl_vec3 v0, zpl_vec3 b, zpl_vec3 v1, float t) {
    float t2 = t * t;
...
void zpl_quat_lerp(zpl_quat *d, zpl_quat a, zpl_quat b, float t)  { zpl_vec4_lerp(&d->xyzw, a.xyzw, b.xyzw, t); }
void zpl_quat_nlerp(zpl_quat *d, zpl_quat a, zpl_quat b, float t) { zpl_quat_lerp(d, a, b, t); zpl_quat_norm(d, *d); }

void zpl_quat_slerp(zpl_quat *d, zpl_quat a, zpl_quat b, float t) {
    zpl_quat x, y, z;
...
void zpl_quat_slerp_approx(zpl_quat *d, zpl_quat a, zpl_quat b, float t) {
...
void zpl_quat_nquad(zpl_quat *d, zpl_quat p, zpl_quat a, zpl_quat b, zpl_quat q, float t) {
    zpl_quat x, y;
...
void zpl_quat_squad(zpl_quat *d, zpl_quat p, zpl_quat a, zpl_quat b, zpl_quat q, float t) {
    zpl_quat x, y;
...
void zpl_quat_squad_approx(zpl_quat *d, zpl_quat p, zpl_quat a, zpl_quat b, zpl_quat q, float t) {
    zpl_quat x, y;
...
int zpl_rect2_contains(zpl_rect2 a, float x, float y) {
...
zpl_u64 zpl_hash_murmur64(void const *key, size_t num_bytes, zpl_u64 seed) {
    zpl_u64 const m = 0xc6a4a7935bd1e995ULL;
    zpl_u64 const r = 47;

    zpl_u64 h = seed ^ (num_bytes * m);

    zpl_u64 *data = (zpl_u64 *)(key);
    zpl_u64 *end = data + (num_bytes / 8);
    unsigned char *data2;
    ...
    switch (num_bytes & 7) {
        case 7: h ^= (zpl_u64)data2[6] << 48;
        case 6: h ^= (zpl_u64)data2[5] << 40;
        case 5: h ^= (zpl_u64)data2[4] << 32;
        case 4: h ^= (zpl_u64)data2[3] << 24;
        case 3: h ^= (zpl_u64)data2[2] << 16;
        case 2: h ^= (zpl_u64)data2[1] << 8;
        case 1: h ^= (zpl_u64)data2[0];
        h *= m;
    };
...
zpl_u64 zpl_hash_murmur64(void const *key, size_t num_bytes, zpl_u64 seed) {
    ...
    zpl_u64 h  = 0;
    zpl_u32 h1 = (zpl_u32)seed ^ (zpl_u32)num_bytes;
    zpl_u32 h2 = (zpl_u32)((zpl_u64)seed >> 32);

    zpl_u32 *data = (zpl_u32 *)key;
